    ...
    <div className="min-h-screen bg-[#F8FAFC] p-4">
      {loading ? (
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          <div className="bg-red-50 border-l-4 border-red-500 p-8 rounded-lg shadow-sm mt-4">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-3xl">⚠️</span>
              <h2 className="text-2xl font-bold text-red-800">Error Running AI Analysis</h2>
            </div>
            <p className="text-red-700 text-lg font-mono bg-red-100 p-4 rounded whitespace-pre-wrap">{error}</p>
            <p className="mt-4 text-slate-600">Please check the browser console for more details.</p>
          </div>
        </div>
      ) : (
        <div className="max-w-6xl mx-auto space-y-6">
